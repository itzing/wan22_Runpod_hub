...
RUN mkdir -p /models/diffusion_models /models/loras/Wan2.2-T2V-A14B-4steps-lora-rank64-Seko-V1.1
...
RUN wget --progress=dot:giga \
      ...
      -O /models/loras/Wan2.2-T2V-A14B-4steps-lora-rank64-Seko-V1.1/high_noise_model.safetensors
...
RUN wget --progress=dot:giga \
      ...
      -O /models/loras/Wan2.2-T2V-A14B-4steps-lora-rank64-Seko-V1.1/low_noise_model.safetensors
